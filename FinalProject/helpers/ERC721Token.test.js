...
const { shouldBehaveLikeERC721BasicToken } = require('/shouldBehaveLikeERC721BasicToken.js');
const { shouldBehaveLikeMintAndBurnERC721Token } = require('/ERC721MintBurnBehaviour.js');
